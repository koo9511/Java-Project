...
<body>
    ...
    <div id="information" class="section">
        ...
        <div class="container">
            ...
            <br> <br>
            <!-- row -->
            <form action="insertdanim.do" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-12 row-md-6 mapyj">
                        ...
                        <div class="map_wrap" cellpadding="30px" style="margin-bottom: 40px;">
                            ...
                            <input id="result2" name="locationcodelng" value="dd" type="text" hidden>
                        </div>
                    ...
                    <div class="col-md-12 row-md-6 mapyj" style="padding-bottom: 40px;">
                        <table cellpadding="30px" class="col-md-4 col-sm-4 col-lg-6">
                            <input type="address" name="detailaddress" id="addressdetailyj" placeholder="상세주소">
                        </table>
                    </div>
                    <div class="col-md-12">
                        <table class="myinfo-table " cellpadding="30px" style="margin-bottom: 40px;">
                            <tr class="tryj fullwidthyj" style="letter-spacing: inherit;" id="timevalyj">
                                ...
                                <td class="col-md-3 reser" style="" id=""><input name="reserdate" type="date" class="boxstyleyj" style="display: none;" id="reser1" hidden="false"></td>
                                <td class="col-md-3 reser" style="padding: 0px;" id=""><select name="resertime" class="boxstyleyj" id="reser2" style="display: none;" hidden="false">
                                        <option value="00:00" selected disabled hidden>00시</option>
                                        <option value="01:00">01시</option>
                                        <option value="02:00">02시</option>
                                        <option value="04:00">03시</option>
                                        <option value="04:00">04시</option>
                                        <option value="05:00">05시</option>
                                        <option value="06:00">06시</option>
                                        <option value="07:00">07시</option>
                                        <option value="08:00">08시</option>
                                        ...
                                        <option value="23:00">23시</option>
                                    </select></td>
                            </tr>
                            <tr class="tryj">
                                <select name="usingtime" class="boxstyleyj" id="">
                    ...
                    <div class="col-md-12 row-md-6 mapyj" style="padding-bottom: 40px;">
                        <table cellpadding="30px" class="col-md-4 col-sm-4 col-lg-6">
                            <input type="text" name="helptitle" id="helptitleyj" placeholder="제목을 적어주세요 ex)가구옮기는것을 도와주세요!!">
                        </table>
                    </div>
                    
                    <div class="col-md-12 tryj" style="margin-bottom: 40px;">
                        <textarea name="contents" placeholder="집 안 가구위치 변경하려 합니다. 아파트 34평형 구조입니다." style="width: 100%; height: 200px;"></textarea>
                    </div>
                    ...
                    <div class="col-md-12 row-md-6 mapyj" style="padding-bottom: 40px;">
                        <table cellpadding="30px" class="col-md-4 col-sm-4 col-lg-6">
                            <input class="" type="text" name="pay" id="addressdetailyj" placeholder="심부름비용(물품구매비용 제외)" onkeyup="inputNumberFormat(this)">
                        </table>
                    </div>
                    ...
                    <div class="col-md-12 tryj" style="margin-bottom: 100px;">
                        <div class="col-sm-6 match" style="float: left;">
                            <div class="col-12 matchingtype">
                                <input type="radio" name="paym" id="matchingradioyj1" class="matchingdetailyj" value="현장결제" style="margin-bottom: 20px;" checked>현장결제
                            </div>
                            <div class="yellow">현장에서 현금및 기타 방법으로 하는 결제 방식 입니다.</div>
                        </div>
                        <div class="col-sm-6 match" style="float: right;">
                            <div class="col-12 matchingtype">
                                <input type="radio" name="paym" id="matchingradioyj2" class="matchingdetailyj" value="코인결제" style="margin-bottom: 20px;">다님코인결제
                            </div>
                    ...
                    <br> <br>
                    <!-- /row -->
                    <button class="main-button icon-button pull-right enrollbutton" type="submit">작성완료</button>
                </div>
            </form>
            <!-- /container -->
