			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">회원 문의 관리</h1>
		...
		<div id="contact" class="section" >
			...
			<div class="container" >
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="">
							<a class="main-button icon-button pull-right" onclick="javascript:location.href='adminContact.do?page=1'" style="cursor: pointer;">비회원 문의 내역</a>
							<h2 style="border-bottom: 2px solid #fcc159; padding-bottom: 30px; padding-left: 2%">회원 문의 내역</h2>
							...
							<table class="mycenter-table">
								...
								<c:forEach var="helpcenter" items="${requestScope.list }">		
									<c:url var="hdt" value="adminHelpCenterDetail.do">
