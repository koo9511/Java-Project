						...
						$.ajax({
							...
							success : function(result){
								switch(result){
									...
									case "900" : alert("이미 가입된 전화번호 입니다.");
												$("#phone").val("");
												 $("#phone").focus();
												 return false;
												 break;
				...
				<div class="row">
					...
					<div class="col-md-6">
							<div class="contact-form">
								<h4>개인정보</h4>
								<input class="input" type="email" name="userid" id="userid" placeholder="아이디로 사용할 이메일"style="width: 68%;" onblur="emailCheck();">
								<button type="button" class="main-button icon-button pull-right emailchkbtn" >인증 메일 발송</button>
								<input class="input" type="text" name="emailcheck" id="emailchkinput" placeholder="인증 번호" style="width: 73%;" hidden>
								...
								<input class="input" type="text" name="usernum" id="usernumber" placeholder="생년월일 (ex : 19951111)" maxlength="8" onblur="usernumCheck();">
