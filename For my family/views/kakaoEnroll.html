		...
		<div id="contact" class="section" >
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- enroll form -->
					<br><br>
					<form action="kakaoUserInsert.do" method="post" onsubmit="return validate();">
					<div class="col-md-6">
							<div class="contact-form">
								<h4>개인정보</h4>
								<input class="input" type="email" name="userid" id="userid" value="${requestScope.user.userid}" readonly>
								<input class="input" type="text" name="nickname" id="nickname" value="${requestScope.user.nickname}">
