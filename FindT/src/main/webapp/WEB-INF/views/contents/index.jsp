...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="resources/contents/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="resources/contents/css/icomoon.css">
	<!-- Themify Icons-->
	<link rel="stylesheet" href="resources/contents/css/themify-icons.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="resources/contents/css/bootstrap.css">

	<!-- Magnific Popup -->
	<link rel="stylesheet" href="resources/contents/css/magnific-popup.css">

	<!-- Bootstrap DateTimePicker -->
	<link rel="stylesheet" href="resources/contents/css/bootstrap-datetimepicker.min.css">

	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="resources/contents/css/owl.carousel.min.css">
	<link rel="stylesheet" href="resources/contents/css/owl.theme.default.min.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="resources/contents/css/style.css">

	<!-- Modernizr JS -->
	<script src="resources/contents/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	<script src="resources/contents/js/respond.min.js"></script>
	<![endif]-->
	...
	<!-- jQuery -->
	<script src="resources/contents/js/jquery.min.js"></script>
	<!-- jQuery Easing -->
	<script src="resources/contents/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="resources/contents/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="resources/contents/js/jquery.waypoints.min.js"></script>
	<!-- Carousel -->
	<script src="resources/contents/js/owl.carousel.min.js"></script>
	<!-- countTo -->
	<script src="resources/contents/js/jquery.countTo.js"></script>

	<!-- Stellar Parallax -->
	<script src="resources/contents/js/jquery.stellar.min.js"></script>

	<!-- Magnific Popup -->
	<script src="resources/contents/js/jquery.magnific-popup.min.js"></script>
	<script src="resources/contents/js/magnific-popup-options.js"></script>
	
	<script src="resources/contents/js/moment.min.js"></script>
	<script src="resources/contents/js/bootstrap-datetimepicker.min.js"></script>


	<!-- Main -->
	<script src="resources/contents/js/main.js"></script>
