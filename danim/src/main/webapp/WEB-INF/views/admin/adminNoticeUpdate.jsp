		...
		<div id="contact" class="section" >
			...
			<div class="container" >
				...
				<div class="row" style="border-bottom: 2px solid #fcc159; padding-bottom: 8px; padding-left: 2%; padding-right: 2%; display: block;" >
                        <input class="pull-left input" value="${requestScope.notice.noticetitle}" style="border: none;" name="noticetitle">
                </div><br>
                    <textarea style="border: none; white-space: pre; color: #374050;" id="noticeDetail" class="autosize" name="noticecontent">${requestScope.notice.noticecontent}</textarea>
                    <br><hr style="border: 1px solid #fcc159;">
                    <button class="main-button icon-button pull-right" type="submit" onclick="javascript:alert('수정되었습니다.');" style="cursor: pointer;">수정하기</button>
                    <button class="main-button icon-button pull-left" onclick="javascript:history.back();" style="cursor: pointer;">취소하기</button>
			</div>
            <!-- /container -->
            <input type="hidden" id="noticeno" name="noticeno" value="${requestScope.notice.noticeno}">
		</div>
        <!-- /Contact -->
        </form>
