		...
		<div id="contact" class="section" >
			...
			<div class="container" >
				...
				<div class="row" style="border-bottom: 2px solid #fcc159; padding-bottom: 8px; padding-left: 2%; padding-right: 2%; display: block;" >
                        <h2 class="pull-left" >${helpcenter.helptitle}</h2>
                        <h4 class="pull-right" >${helpcenter.helpdate}</h4>
                        <c:if test="${helpcenter.helpstatus eq '미완료'}"><h4 style="color: #f75b5b; margin-right: 5%;" class="pull-right"></c:if>
                        <c:if test="${helpcenter.helpstatus eq '답변완료'}"><h4 style="color: rgb(12, 194, 12); margin-right: 5%;" class="pull-right"></c:if>
                            ${helpcenter.helpstatus}</h4>
                        <h4 class="pull-right" style="margin-right: 5%;">종류 : ${helpcenter.helpcategory}</h4>
                </div>
                <br>
                    <textarea style="border: none; white-space: pre; color: #374050;" id="noticeDetail" class="autosize" disabled>${helpcenter.helpcontent}</textarea>
                    ...
                    <a href="mailto:${helpcenter.helpuserid}" class="main-button icon-button pull-right" style="cursor: pointer;">답변하기</a>
                    <c:if test="${helpcenter.helpstatus eq '미완료'}">
                        <a href="javascript:location.href='adminHelpCenterAnswer.do?helpcenterno=${helpcenter.helpcenterno}'" class="main-button icon-button pull-right" style="cursor: pointer; margin-right: 5%;">완료하기</a>
                    </c:if>
			</div>
            <!-- /container -->
