									...
									success: function(res) {
									  ...
									  $.post({
										  ...
										  success: function(result){
											...
											switch(result){
												case "100": alert(nickname + "님 환영합니다!");
															// $.ajax({
															// 	type:'POST',
															// 	data:{userid : res.kaccount_email},
															// 	url: "kakaoLoginSuccess.do"	
															// });
															location.href="kakaoLoginSuccess.do?userid=" + userid; // 등록된 회원이면 메인으로
														
															break;
												case "900": alert("추가 정보 등록 페이지로 이동합니다.");	
															location.href="kakaoEnroll.do?userid=" + userid + "&nickname=" + nickname;
