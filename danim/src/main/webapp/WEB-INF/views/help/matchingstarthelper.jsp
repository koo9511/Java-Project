...
<body>
    ...
    <div id="information" class="section">
            ...
            <div class="row">
                <div class="col-md-12 mapyj">
                    <div class="row">
                        ...
                        <div class="col-xs-6" valign="top" style="line-height:20px;">
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="row">
                            ...
                            <div class="row" style="margin-bottom:40px;">
                                ...
                                <div class="tdyj1 col-xs-6 yellowlabelyj">주소</div>
                ...
                <div class="col-md-12">
					...
					<div class="row">
	                    		...
	                    		<div class="col-xs-6 pull-left">
	                                    <a class="main-button icon-button curonyj" onclick="javascript:history.back();" style="z-index: 2;margin-bottom: 40px;margin-top: 40px; margin-right:20px;">뒤로가기</a>
	                        	</div>
	                   			<div class="col-xs-6">
	                   				<div class="pull-right row">
	                   				<c:if test="${help.helperid eq loginUser.userid and help.status ne '완료'}">
			                   				<span id="cancelbtn" class="">
				                   				...
				                   				<c:if test="${help.cancelstatus eq null or help.cancelstatus ne loginUser.userid}">
				                            ...
				                            <span id="matchingbtn">
					                            <c:if test="${help.matchingstatus eq loginUser.userid }">
					                                    <a class="main-button icon-button curonyj" onclick="matching();" style="background-color:#EBEBEB; white-space:nowrap; z-index: 2;margin-bottom: 40px;margin-top: 40px;">완료대기중</a>
					                    		</c:if>
					                            <c:if test="${help.matchingstatus eq null or help.matchingstatus eq help.helpid}">
        ...
        <script>
            ...
            function myloc() {
                map.setLevel(4);
                map.panTo(new kakao.maps.LatLng(Number(${help.locationcodelat
                }), Number(${help.locationcodelng})));
