    ...
    e.fn.imageUploader = function (t) {
        ...
        let d = function () {
                ...
                e("<div>", {
                    ...
                    text: "드래그앤드롭 혹은 클릭하여 이미지를 업로드 할 수 있습니다."
                }).appendTo(i), e("<span>", {
            ...
            l = function (t, i, d) {
                ...
                return l.on("click", function (e) {
                    ...
                    if (o(t), !0 === l.data("preloaded")) a.settings.preloaded = a.settings.preloaded.filter(function (e) {
                        return e.id !== i
                    });
                    else {
                        let t = parseInt(l.data("index"));
                        l.parent().find(".uploaded-image[data-index]").each(function (n, i) {
                            n > t && e(i).attr("data-index", n - 1)
                        }), s.items.remove(t), n.prop("files", s.files)
                    }
                    l.remove(), l.find(".uploaded-image").length || l.removeClass("has-files")
                }), l
            },
            r = function (t) {
            ...
            p = function (t) {
                o(t);
                let n = e(this),
                    i = Array.from(t.target.files || t.originalEvent.dataTransfer.files),
                    s = [];
                e(i).each(function (e, t) {
                    a.settings.extensions && !g(t) || a.settings.mimes && !c(t) || a.settings.maxSize && !m(t) || a.settings.maxFiles && !f(s.length, t) || s.push(t)
                }), s.length && (n.removeClass("drag-over"), u(n, s))
            },
            g = function (e) {
