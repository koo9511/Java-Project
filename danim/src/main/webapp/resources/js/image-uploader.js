...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            label: "드래그앤드롭 혹은 클릭하여 이미지를 업로드 할 수 있습니다.",
        ...
        let createContainer = function () {
            ...
            let $uploadedContainer = $('<div>', {class: 'uploaded'}).appendTo($container),
                ...
                $i = $('<div>', {class: 'material-iconsf'}).appendTo($textContainer),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image', name: 'image'}),
                ...
                $i = $('<div>', {class: 'material-iconsf', text: 'Ｘ'}).appendTo($button);
