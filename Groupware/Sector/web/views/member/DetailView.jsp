    ...
    <% } %>
                    ...
                    <br><br>
                        <table cellspacing="5" cellpadding="0" class="view">
                             <tr>
                                 <th colspan="2" rowspan="2"><h2>내 정보</h2></th>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                 <th>이 름</th>
                                 <td>
                                     <input type="text" name="username" class="infoinput" value="<%=loginMaster.getMasterName()%>" readonly>
                                 </td>
                             </tr>
                             <tr>
                                 <th>아이디</th>
                                 <td>
                                     <input type="text" name="userid" class="infoinput" value="<%=loginMaster.getMasterId()%>" readonly>
                                 </td>
                             </tr>
                             <tr>
                                 <th>전화번호</th>
                                 <td>
                                     <input type="text" name="phone" class="infoinput" value="<%= loginMaster.getMasterPhone() %>" readonly>
                                 </td>
                             </tr>
                             <tr>
                                 <th>이메일</th>
                                 <td>
                                     <input type="email" name="email" class="infoinput" value="<%= loginMaster.getMasterEmail() %>" readonly>
                                 </td>
                             </tr>
                             <tr>
                                 <th>회사명</th>
                                 <td>
                                     <input type="text" name="comname" class="infoinput" value="<%= loginMaster.getMasterComName() %>" readonly>
                                 </td>
                             </tr>
                             <tr>
                                 <th>서비스 여부</th>
                                 <td>
                                     <input type="text" name="comname" class="infoinput" value="<%= loginMaster.getMaster() %>" readonly>
                                 </td>
                                </tr>
                             <tr>
                                 <th colspan="2">
